...
import './View_expense.css'; // Ensure you have your CSS file
...
const View_expense = () => {
  return (
    <Sidebar showSearchBar={false} pageName={"Expense Overview"}>
      ...
      <div className="top-div">
        <div className="financial-overview">
          ...
          <div className="overview-cards">
            <div className="card">
              <div className="card-icon"><FontAwesomeIcon icon={faCamera} /></div>
            ...
            <div className="card">
              <div className="card-icon"><FontAwesomeIcon icon={faCreditCard} /></div>
              <div className="card-info">
          ...
          <div className="search-period">
            <button>Search this week <FontAwesomeIcon icon={faChevronDown} /></button>
          </div>
        </div>
      </div>
